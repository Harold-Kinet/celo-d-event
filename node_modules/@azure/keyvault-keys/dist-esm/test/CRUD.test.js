...
describe("Keys client - create, read, update and delete operations", function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        poller = _a.sent();
                        assert.equal(poller.getResult().name, keyName, "Unexpected key name in result from beginDeleteKey().");
                        return [4 /*yield*/, poller.pollUntilDone()];
                    case 3:
                        _a.sent();
                    ...
                    case 4:
                        getResult = _a.sent();
                        assert.equal(getResult.name, keyName, "Unexpected key name in result from poller.getResult().");
                        return [4 /*yield*/, client.getDeletedKey(keyName)];
                    case 5:
                        getResult = _a.sent();
    ...
    it("can purge a deleted key", function () {
        return __awaiter(this, void 0, void 0, function () {
            var keyName, poller;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        return [4 /*yield*/, client.purgeDeletedKey(keyName)];
                    case 4:
                        _a.sent();
                        return [2 /*return*/];
                }
