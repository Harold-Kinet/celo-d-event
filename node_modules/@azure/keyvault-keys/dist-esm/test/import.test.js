...
describe("Keys client - import keys", function () {
    var prefix = "merge" + (env.CERTIFICATE_NAME || "KeyName");
    var suffix;
    var client;
    var testClient;
    var recorder;
    ...
    it("can import a key", function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            var keyName, jsonWebKey, key;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        keyName = testClient.formatName(prefix + "-" + this.test.title + "-" + suffix);
                        jsonWebKey = {
                            kty: "RSA",
                        ...
                        return [4 /*yield*/, client.importKey(keyName, jsonWebKey)];
                    case 1:
                        key = _a.sent();
