...
describe('Phone number formatting and utilities', function () {
    describe('Phone hashing', function () {
        it('Hashes an valid number without a salt', function () {
            expect(phoneNumbers_1.getPhoneHash(TEST_PHONE_NUMBERS.VALID_E164)).toBe('0x4465dd287f82f531502bb84201231dac162cbc2077abf455a5a87f9738c0337d');
        });
        it('Hashes an valid number with a salt', function () {
            expect(phoneNumbers_1.getPhoneHash(TEST_PHONE_NUMBERS.VALID_E164, 'abcdefg')).toBe('0xfe2835a235ffb2f98dcf259a710dc23751af20bf1a0284829a0cde0c720c3595');
        });
